function dadosBaseProcesso() {
  ...
  function processoUniTrac2() {
    ...
    for (var i = 0; i < linha.length; i++) {
      ...
      if (produto[i] == "UniTrac 2.0" && linha[i] == "Defasagem") {

        defasagem.push(processo[i], operadores[i], pecas[i], sequencia[i], paralelo[i], diaNecessario[i], linha[i], filho[i])
      }
      else if (produto[i] == "UniTrac 2.0" && linha[i] == "Industrialização") {

        industrializacao.push(processo[i], operadores[i], pecas[i], sequencia[i], paralelo[i], diaNecessario[i], linha[i], filho[i])
      }

      else if (produto[i] == "UniTrac 2.0" && linha[i] == "Produção / Montagem") {
  ...
  function processoOEETrac() {
    ...
    for (var i = 0; i < linha.length; i++) {
      ...
      if (produto[i] == "OEE Trac" && linha[i] == "Defasagem") {

        defasagem.push(processo[i], operadores[i], pecas[i], sequencia[i], paralelo[i], diaNecessario[i], linha[i], filho[i])
      }
      else if (produto[i] == "OEE Trac" && linha[i] == "Industrialização") {

        industrializacao.push(processo[i], operadores[i], pecas[i], sequencia[i], paralelo[i], diaNecessario[i], linha[i], filho[i])
      }

      else if (produto[i] == "OEE Trac" && linha[i] == "Produção / Montagem") {
  ...
  function processoOmniTrac() {
    ...
    for (var i = 0; i < linha.length; i++) {
      ...
      if (produto[i] == "Omni Trac" && linha[i] == "Defasagem") {

        defasagem.push(processo[i], operadores[i], pecas[i], sequencia[i], paralelo[i], diaNecessario[i], linha[i], filho[i])
      }
      else if (produto[i] == "Omni Trac" && linha[i] == "Industrialização") {

        industrializacao.push(processo[i], operadores[i], pecas[i], sequencia[i], paralelo[i], diaNecessario[i], linha[i], filho[i])
      }

      else if (produto[i] == "Omni Trac" && linha[i] == "Produção / Montagem") {
  ...
  function processoOmniReceiver() {
    ...
    for (var i = 0; i < linha.length; i++) {
      ...
      if (produto[i] == "Omni Receiver" && linha[i] == "Defasagem") {

        defasagem.push(processo[i], operadores[i], pecas[i], sequencia[i], paralelo[i], diaNecessario[i], linha[i], filho[i])
      }
      else if (produto[i] == "Omni Receiver" && linha[i] == "Industrialização") {

        industrializacao.push(processo[i], operadores[i], pecas[i], sequencia[i], paralelo[i], diaNecessario[i], linha[i], filho[i])
      }

      else if (produto[i] == "Omni Receiver" && linha[i] == "Produção / Montagem") {
  ...
  function processoSmartTracUltraExGen2() {
    ...
    for (var i = 0; i < linha.length; i++) {
      ...
      if (produto[i] == "Smart Trac Ultra Ex Gen 2" && linha[i] == "Defasagem") {
        defasagem.push(processo[i], operadores[i], pecas[i], sequencia[i], paralelo[i], diaNecessario[i], linha[i], filho[i])
      }
      else if (produto[i] == "Smart Trac Ultra Ex Gen 2" && linha[i] == "Industrialização") {
        industrializacao.push(processo[i], operadores[i], pecas[i], sequencia[i], paralelo[i], diaNecessario[i], linha[i], filho[i])
      }
      else if (produto[i] == "Smart Trac Ultra Ex Gen 2" && linha[i] == "Produção / Montagem") {
        montagem.push(processo[i], operadores[i], pecas[i], sequencia[i], paralelo[i], diaNecessario[i], linha[i], filho[i])
      }
  ...
  function processoOmniReceiverMX() {
    ...
    for (var i = 0; i < linha.length; i++) {
      ...
      if (produto[i] == "Omni Receiver MX" && linha[i] == "Defasagem") {

        defasagem.push(processo[i], operadores[i], pecas[i], sequencia[i], paralelo[i], diaNecessario[i], linha[i], filho[i])
      }
      else if (produto[i] == "Omni Receiver MX" && linha[i] == "Industrialização") {

        industrializacao.push(processo[i], operadores[i], pecas[i], sequencia[i], paralelo[i], diaNecessario[i], linha[i], filho[i])
      }

      else if (produto[i] == "Omni Receiver MX" && linha[i] == "Produção / Montagem") {
  ...
  function calculoDefasagem() {
    ...
    let smartTracUltraGen2Prod = ["PROD-0140", "PROD-0152", "PROD-0153"];
    let smartTracUltraExGen2Prod = ["PROD-0164"];
    let uniTrac2Prod = ["PROD-0150", "PROD-0147", "PROD-0149", "PROD-0148"];
    let oeeTracProd = ["PROD-0156"];
    let omniTracProd = ["PROD-0154"];
    let omniReceiverProd = ["PROD-0127"];
    let omniReceiverMXProd = ["PROD-0172"];

    let prodProdutos = [gatewayProProd, gatewayUltraProd, smartTracProProd, smartTracUltraProd, smartTrcUltraExProd, energyTracProd, uniTracProd, smartTracUltraGen2Prod, smartTracUltraExGen2Prod, uniTrac2Prod, oeeTracProd, omniTracProd, omniReceiverProd, omniReceiverMXProd]
    let funcaoProduto = [processoGatewayPro(), processoGatewayUltra(), processoSmartTracPro(), processoSmartTracUltra(), processoSmartTracUltraEx(), processoEnergy(), processoUniTrac(), processoSmartTracUltraGen2(), processoSmartTracUltraExGen2(), processoUniTrac2(), processoOEETrac(), processoOmniTrac(), processoOmniReceiver(), processoOmniReceiverMX()]
  ...
  function calculoIndustrializacao() {
    ...
    let smartTracUltraExGen2Prod = ["ITCS-0019"]
    let energyTracProd = ["PROA-0013", "ITCS-0001"]
    let uniTracProd = ["PROD-0079", "PROD-0080", "PROD-0081", "PROD-0082", "PROD-0078"]
    let baterias = ["ITCS-0002","ITCS-0012","ITCS-0014","ITCS-0015","ITCS-0019","ITCH-0011"]
    let oeeTracProd = ["ITCH-0011"]


    let prodProdutos = [smartTracProProd, smartTracUltraProd, smartTrcUltraExProd, smartTracUltraExGen2Prod, energyTracProd, uniTracProd, baterias, oeeTracProd]
    let funcaoProduto = [processoSmartTracPro(), processoSmartTracUltra(), processoSmartTracUltraEx(), processoSmartTracUltraExGen2(), processoEnergy(), processoUniTrac(), processoBaterias(), processoOEETrac()]
